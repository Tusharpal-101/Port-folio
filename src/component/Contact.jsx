    ...
    >
      <div className="flex flex-col p4 justify-center max-w-screen-lg mx-auto h-full">
        <div className="pb-8">
          ...
          <p className="py-6">
            Submit the form below to get in tounch with me{' '}
          </p>
        </div>

        <div className="flex justify-center items-center">
          <form
            action="https://getform.io/f/2fecdf9a-c2eb-4c6a-8575-10613afd65ff"
            method="POST"
          ...
          >
            ...
            <button
              className="text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 
                py-3 my-8 p-4  mx-auto
              flex item-center rounded-md hover:scale-105 duration-300"
            >
              Let's talk
            </button>
          </form>
